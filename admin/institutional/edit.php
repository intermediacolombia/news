...
function oldv($key, $default=''){
  global $old, $page;
  return htmlspecialchars($old[$key] ?? $page[$key] ?? $default, ENT_QUOTES, 'UTF-8');
}

$oldStatus = $old['status'] ?? $page['status'] ?? 'draft';
$oldType   = $old['page_type'] ?? $page['page_type'] ?? 'general';
?>
<!doctype html>
<html lang="es">
<head>
  <meta charset="utf-8">
  <title>Editar Página Institucional</title>
...
<div class="container" style="padding: 0px; background:rgba(0,0,0,0.00)">
  <div class="portada">
    <h1 class="mb-4"><i class="bi bi-building"></i> Editar Página Institucional</h1>
  </div>
</div>
...
<div class="wrap">
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
      <h5 class="mb-0">Editar: <?= htmlspecialchars($page['title']) ?></h5>
      ...
      <form method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="row g-4">
          <div class="col-lg-8">
            ...
            <p class="text-muted">Optimiza cómo aparecerá esta página en buscadores.</p>
          ...
          <div class="col-lg-4">
            ...
            <div class="mb-3">
              ...
              <?php endif; ?>
              <div class="hint mt-1">Orden de aparición en menús</div>
            </div>
            ...
            <div class="mb-4">
              ...
              <?php if(!empty($page['image'])): ?>
                <div class="current-image mb-2">
                  <img src="<?= htmlspecialchars($url . $page['image']) ?>" 
                       alt="Imagen actual" 
              ...
              <div class="img-drop">
                ...
                <div class="hint mt-2">JPG/PNG/WebP, máx 5 MB. Dejar vacío para mantener la actual.</div>
...
<script>
/* Slug auto (solo si está vacío o no ha sido tocado) */
