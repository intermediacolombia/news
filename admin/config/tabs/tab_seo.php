...
<div class="tab-pane fade" id="seo">
  ...
  <!-- SEO Basico -->
  <div class="card mb-3">
    <div class="card-header bg-light"><strong><i class="fab fa-google me-2"></i>SEO Pagina Principal</strong></div>
    <div class="card-body">
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        <label class="form-label fw-semibold"><i class="fab fa-google me-1 text-primary"></i> Publisher ID</label>
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        <label class="form-label fw-semibold"><i class="fab fa-google me-1" style="color:#4285F4"></i> Google Search Console</label>
      ...
      <div class="mb-3">
        <label class="form-label fw-semibold"><i class="fab fa-microsoft me-1" style="color:#00A4EF"></i> Bing Webmaster Tools</label>
      ...
      <div class="mb-3">
        <label class="form-label fw-semibold"><i class="fa fa-globe me-1" style="color:#FF0000"></i> Yandex Webmaster</label>
      ...
      <div class="mb-3">
        <label class="form-label fw-semibold"><i class="fab fa-meta me-1" style="color:#0866FF"></i> Meta (Facebook Domain Verification)</label>
      ...
      <div class="mb-3">
        <label class="form-label fw-semibold"><i class="fab fa-pinterest me-1" style="color:#E60023"></i> Pinterest</label>
