...
<head>
    ...
    <?php else: ?>
        <title><?= htmlspecialchars($sys['site_name'] ?? 'Noticias') ?></title>
    <?php endif; ?>
    ...
    <link href="<?= URLBASE ?>/template/news/lib/animate/animate.min.css" rel="stylesheet">
    <link href="<?= URLBASE ?>/template/news/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="<?= URLBASE ?>/template/news/css/bootstrap.min.css" rel="stylesheet">
