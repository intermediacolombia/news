            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7">
                    <form id="contactForm" method="post" action="enviar_contacto.php" class="mb-4">
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <input type="text" name="name" class="w-100 form-control border-0 py-3" placeholder="<?= t_theme('theme_tu_nombre') ?>" required>
                            </div>
                            <div class="col-lg-6">
                                <input type="email" name="email" class="w-100 form-control border-0 py-3" placeholder="<?= t_theme('theme_tu_correo') ?>" required>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" name="phone" class="w-100 form-control border-0 py-3" placeholder="<?= t_theme('theme_tu_telefono') ?>">
                            </div>
                            <div class="col-lg-6">
                                <input type="text" name="subject" class="w-100 form-control border-0 py-3" placeholder="<?= t_theme('theme_asunto') ?>">
                            </div>
                            <div class="col-12">
                                <textarea name="message" class="w-100 form-control border-0" rows="6" placeholder="<?= t_theme('theme_tu_mensaje') ?>"></textarea>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="w-100 btn btn-primary form-control py-3"><?= t_theme('theme_enviar_mensaje') ?></button>
                            </div>
                        </div>
                    </form>
