                                ...
                                <div class="col-4">
                                    <div class="rounded-circle position-relative">
                                        <div class="overflow-hidden rounded-circle">
                                            <img src="<?= $p['image'] ? URLBASE . '/' . htmlspecialchars($p['image']) : URLBASE . '/template/news/img/features-sports-1.jpg' ?>" class="img-zoomin img-fluid rounded-circle w-100" alt="<?= htmlspecialchars(get_image_alt($p['image'], $p['title'])) ?>">
                                        </div>
