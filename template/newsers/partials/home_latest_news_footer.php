                            ...
                            <div class="bg-light rounded">
                                ...
                                <div class="d-flex flex-column p-4">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="small text-body"><?= t_theme('theme_por') ?> <a href="<?= URLBASE ?>/autor/<?= urlencode($newsItem['author']) ?>/" class="text-decoration-none"><?= htmlspecialchars($newsItem['author']) ?></a></span>
                                        <?php else: ?>
