...
<div class="container-fluid py-5">
    <div class="container py-3">
        <div class="row g-4 align-items-center mb-5">
            ...
            <div class="col-md-8">
                <?php if (!empty($program['category'])): ?>
                    <span class="badge bg-primary mb-2"><?= htmlspecialchars($program['category']) ?></span>
                <?php endif; ?>
                <h1 class="mb-2"><?= htmlspecialchars($program['title']) ?></h1>
                <?php if (!empty($program['hosts'])): ?>
                    <p class="text-muted"><i class="fas fa-user me-2"></i><?= htmlspecialchars($program['hosts']) ?></p>
                <?php endif; ?>
        ...
        <div class="bg-light p-4 rounded">
            <h4 class="mb-3"><i class="fas fa-clock me-2" style="color:var(--primary);"></i> Horarios</h4>
