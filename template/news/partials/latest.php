            ...
            <div class="position-relative mb-3">
                ...
                <div class="overlay position-relative bg-light">
                    <div class="mb-2" style="font-size: 14px;">
                        ...
                        <span><?= fecha_espanol(date("F d, Y", strtotime($latestPosts[0]['created_at']))) ?></span>
                    </div>
                    <a class="h4" href="<?= URLBASE ?>/<?= htmlspecialchars($latestPosts[0]['category_slug']) ?>/<?= htmlspecialchars($latestPosts[0]['slug']) ?>/">
            ...
            <div class="position-relative mb-3">
                ...
                <div class="overlay position-relative bg-light">
                    <div class="mb-2" style="font-size: 14px;">
                        ...
                        <span class="px-1">/</span>
                        <span><?= fecha_espanol(date("F d, Y", strtotime($latestPosts[1]['created_at']))) ?></span>
                    </div>
                    <a class="h4" href="<?= URLBASE ?>/<?= htmlspecialchars($latestPosts[1]['category_slug']) ?>/<?= htmlspecialchars($latestPosts[1]['slug']) ?>/">
