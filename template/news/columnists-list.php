...
<div class="container-fluid py-3">
    <div class="container-bk">
        <div class="bg-light py-2 px-4 mb-3">
            <h3 class="m-0"><?= t_theme('theme_nuestros_columnistas') ?></h3>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card text-center h-100 shadow-sm p-3" style="border-radius:8px;">
                    ...
                    <?php else: ?>
                        <div style="width:100px; height:100px; border-radius:50%; background:var(--primary); display:flex; align-items:center; justify-content:center; margin:0 auto 15px; border:3px solid var(--primary);">
                            <span style="color:#fff; font-size:32px; font-weight:700;"><?= $iniciales ?></span>
                        </div>
                    <?php endif; ?>
                    <h5><?= htmlspecialchars($nombreCompleto) ?></h5>
                    <p class="text-muted small" style="text-transform:uppercase;">Columnista</p>
