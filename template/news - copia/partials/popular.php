...
function safe_excerpt($html, $limit = 30) {
    $clean = strip_tags($html, '<b><i><strong><em><a>'); // permitir solo estas etiquetas
            ...
            <div class="position-relative mb-3">
                ...
                <div class="overlay position-relative bg-light">
                    <div class="mb-2" style="font-size: 14px;">
                        ...
                        <span><?= date("F d, Y", strtotime($popularPosts[0]['created_at'])) ?></span>
                    </div>
                    ...
                    <p class="m-0"><?= safe_excerpt($popularPosts[0]['content'], 30) ?></p>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="position-relative mb-3">
                ...
                <div class="overlay position-relative bg-light">
                    <div class="mb-2" style="font-size: 14px;">
                        ...
                        <span class="px-1">/</span>
                        <span><?= date("F d, Y", strtotime($popularPosts[1]['created_at'])) ?></span>
                    </div>
                    ...
                    <p class="m-0"><?= safe_excerpt($popularPosts[1]['content'], 30) ?></p>
                </div>
            </div>
        <?php endif; ?>
